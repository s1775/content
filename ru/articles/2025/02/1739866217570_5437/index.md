...
Инструкция, которая позволит мигрировать компоненты {{< tag "iRedMail" >}}, устанавливаемые из стандартных репозиториев {{< tag "Debian" >}} на более новые версии из официальных репозиториев разработчиков.
...
```bash
f='iRedMail.backup.utf8mb4.sql'; sed -i -e 's|utf8mb3|utf8mb4|g' -e 's|ascii|utf8mb4|g' -e 's|_general_ci|_unicode_ci|g' "${f}"
```
