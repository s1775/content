...
```bash
f=('server' 'mariadb-dump'); d='/etc/mysql/mariadb.conf.d'; s='https://libsys.ru/ru/2025/02/0068df20-232a-55a2-a487-52dc746a4f47'; for i in "${f[@]}"; do curl -fsSLo "${d}/90-${i}.local.cnf" "${s}/${i}.cnf"; done
```
