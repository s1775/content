...
- `auth_param` - параметр авторизации.
  - `basic` - базовый.
    - `/etc/squid/users.conf` - файл с логинами и паролями для пользователей.
...
- `acl` - список доступа.
  - `clients` - название списка доступа для авторизации пользователей БЕЗ ввода логина и пароля.
    - `/etc/squid/clients.conf` - файл IP-адресов клиентов для авторизации БЕЗ ввода логина и пароля.
