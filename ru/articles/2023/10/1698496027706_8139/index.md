...
{{< file "cmd.set.env.path.system.bat" "bat" >}}
...
{{< file "cmd.set.env.path.user.bat" "bat" >}}
...
{{< file "pwsh.set.env.path.system.ps1" "pwsh" >}}
...
{{< file "pwsh.set.env.path.user.ps1" "pwsh" >}}
...
{{< file "pwsh.set.env.path.ps1" "pwsh" >}}
